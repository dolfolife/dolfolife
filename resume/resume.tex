...
\begin{itemize}
    ...
    \item Led and implemented a system queue of fleet of kubernetes clusters for testing purposes that reduced the waiting time of CI systems.
    \item Led Kubernetes sessions across the organization that built the foundation to migrate Cloud Foundry to Kubernetes.
\end{itemize}
