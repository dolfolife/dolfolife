...
\cvsection{TL;DR}
\cvevent{Rodolfo is an Engineering Manager with a decade of experience leading teams and is passionate about career goals and motivation.}{}{}{}
\cvevent{He is working with teams to build application platforms on Kubernetes.}{}{}{}
...
\cvevent{Software Engineering Manager}{VMware}{Jan 2020 -- Ongoing}{Austin, Texas}
\begin{itemize}
\item Delivering a functional programming model experience on Kubernetes.
\item building an eventing runtime for Kubernetes.
\item Building the system to aggregate DORA metrics for internal teams working on Kubernetes clusters.
\end{itemize}
...
\cvevent{Several Software Engineering positions}{Sears,Enova, and others}{2009 -- 2016}{Chicago, IL}
\begin{itemize}
...
\wheelchart{1.5cm}{0.5cm}{%
  ...
  3/8em/accent!40/Learning new technologies and management skills,
  8/8em/accent!60/{Coaching, mentoring, and sponsoring teams},
