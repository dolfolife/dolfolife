...
- **Leadership & Strategy**: Engineering Management, Team Building, Product Strategy, Technical Direction, Mentorship, Operational Excellence
- **Architecture & Cloud**: Domain Driven Design, Kubernetes, Platform Engineering, Event-Driven Arch., Distributed Systems, Authorization/OAuth
- **Processes & Practices**: Agile Methodologies, CI/CD Pipelines, DORA Metrics, Incident Management, Blameless Post-Mortems
- **Technology Stack**: Go (Golang), Python, Java/Kotlin, JavaScript/TypeScript
...
- Learning AI Agentic flows using LangChain and LangGraph, exploring how to build intelligent, autonomous systems that can reason and take action.
- Contributing to open-source projects including Knative Eventing and Functions for Knative as a maintainer.
- Bringing reactive and event-driven programming patterns into the portfolio of paradigms people use to build their applications.
